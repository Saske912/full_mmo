...
2. **Postgres / баланс:** контент и нагрузка; CI и пост-деплой: [ci-and-deploy.md](../backend/docs/ci-and-deploy.md), [backend-ci.yml](../.github/workflows/backend-ci.yml).
