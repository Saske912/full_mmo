...
2. **Postgres / баланс:** развитие контента (**`branch_*`**, награды, экономика), нагрузочные сценарии; в CI — см. [`../.github/workflows/backend-ci.yml`](../.github/workflows/backend-ci.yml) (`go test`; после деплоя вне CI — **`make verify-readyz-goose`**).
