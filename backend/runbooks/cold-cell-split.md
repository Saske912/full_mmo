...
## 8. Каталог сущностей и развитие handoff

- **ListMigrationCandidates** / `mmoctl … migration-dry-run` — стартовая точка для автоматизации выбора сущностей перед **`forward-npc-handoff`** (см. §6–7).
